...
public class Library {
    ...
    {
        int x;
        System.out.println("Enter the choice as Faculty or a  Student ?(1/0)");
        ...
        if(x == 1)
        {
            ...
            if(n > 0)
            {
                System.out.println("There are " +n+ " more days for the renewal");
            }
            else
            {
                System.out.println("You are " +(n * -1)+ " days late for the renewal");
            }
